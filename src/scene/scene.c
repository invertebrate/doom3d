...
/*   Updated: 2020/12/10 18:20:03 by ohakola          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		place_test_object(t_doom3d *app)
{
	app->active_scene->objects[app->active_scene->num_objects++] =
		...
		app->unit_size, false);
	l3d_3d_object_rotate(app->active_scene->objects[0], 90, 90, 0);
	l3d_3d_object_translate(app->active_scene->objects[0],
		0, app->unit_size, 0);
	l3d_object_set_shading_opts(app->active_scene->objects[0], e_shading_depth);
}
