...
/*   Updated: 2020/12/23 16:34:57 by ahakanen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	npc_spawn(t_doom3d *app, t_list *npc_list, t_vec3 pos, t_vec2 dir, int type, int hp_override)
{
	static int	next_id;
	t_npc		*npc;
	t_list		tmp;
