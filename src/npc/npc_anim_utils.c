...
/*   Updated: 2021/05/03 17:57:08 by sotamursu        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	npc_anim3d_material_copy(t_3d_object *source, t_3d_object *dest)
{
	int		i;
...
void	init_anim_instance(t_doom3d *app, t_anim_3d_instance *anim_instance)
{
...
void	npc_animation_3d_data_copy(t_npc *npc, t_anim_metadata *anim_data)
{
	int		i;
	t_mat4	id_matrix;
