...
/*   Updated: 2021/05/02 19:18:02 by ohakola          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		handle_player_rotate(t_doom3d *app, int32_t xrel, int32_t yrel)
{
	...
	rotate_third_person_camera_vertical(app, (float)yrel * 0.3);
	rotate_third_person_camera_horizontal(app, (float)xrel * 0.3);
}
