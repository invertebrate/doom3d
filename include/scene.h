...
/*   Updated: 2021/01/23 16:44:12 by ohakola          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct				s_asset_files
{
	...
	uint32_t				num_model_animation_frames;
	uint32_t				num_models;
...
typedef struct				s_scene
{
	...
	t_hash_table			*models;
	t_hash_table			*model_anim_frames;
